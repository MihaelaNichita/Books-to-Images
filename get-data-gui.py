...
def change_par():
    ...
    try:
        ...
        messagebox.showwarning("Warning","Something went wrong when trying to change the paragraph! \nPlease contact Mihaela Nichita.")
        return
...
def getPOS(par):    
    try:
        ...
        messagebox.showwarning("Warning","Something went wrong when trying to identify the parts of speech! \nPlease contact Mihaela Nichita.")
        return
...
def createButtons(list,xi,yi,col):
    try:  
        ...
        messagebox.showwarning("Warning","Something went wrong when trying to create buttons! \nPlease contact Mihaela Nichita.")
        return
...
def check_comb(event):
    try:
        ...
        messagebox.showwarning("Warning","Something went wrong when trying to send the combination to the list of chosen words! \nPlease contact Mihaela Nichita.")
        return
...
def genComb(event):
    ...
    try:
        ...
        messagebox.showwarning("Warning","Something went wrong when trying to generate combinations of words! \nPlease contact Mihaela Nichita.")
        return
...
def reset(event):
    try:
        ...
        messagebox.showwarning("Warning","Something went wrong when resetting! \nPlease contact Mihaela Nichita.")
        return
...
def getInfo():
    try:
        ...
        messagebox.showwarning("Warning","Something went wrong when trying to open information window! \nPlease contact Mihaela Nichita.")
        return
...
def openBooksList():
    ...
    try:
        ...
        messagebox.showwarning("Warning","Something went wrong when trying to open the list of books! \nPlease contact Mihaela Nichita.")
        return
...
def openWebSite(event):
    try:
        ...
        messagebox.showwarning("Warning","Something went wrong when trying to open the browser! \nPlease contact Mihaela Nichita.")
        return
...
def openArticlesList():
    ...
    try:
        ...
        m_info = Message(art_list, text = 'Copy and Paste below the full link of the article you\'d like to read. Also, make sure you are connected to internet.', width = 700)
        ...
        messagebox.showwarning("Warning","Something went wrong when trying to open the articles window! \nPlease contact Mihaela Nichita.")
        return
